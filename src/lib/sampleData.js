...
const institutions = [
  {
    ...
    email: "ojt.coordinator@sut.edu.ph",
    logo_url: null,
  ...
  },
  {
    ...
    contact_person: "Prof. Juan Dela Cruz",
    contact_number: "+63 2 8765 4321",
    email: "dean@mcb.edu.ph",
    logo_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
...
const interns = [
  ...
  },
  {
    ...
    required_hours: 300, status: "active", avatar_url: null,
    institution_id: "inst-1", program_id: "prog-2",
  },
  {
    ...
    institution_id: null, program_id: null,
  },
  {
  ...
  },
  {
    ...
    institution_id: "inst-2", program_id: "prog-3",
  },
  {
