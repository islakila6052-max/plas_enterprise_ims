...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-emerald-50 via-white to-green-100">
      <div className="flex flex-1 items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          {/* Login Form - Removed mt-8 since logo already has big margin */}
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="surface animate-fade-up space-y-5 p-6 rounded-xl shadow-lg border border-emerald-100/50 bg-white/80 backdrop-blur-sm">
            {serverError && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  } bg-white/70 px-4 py-2.5 pr-11 text-sm text-slate-800 placeholder:text-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all duration-200`}
                  {...register("password", {
            ...
            <Button
              type="submit"
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
              loading={submitting}>
              Sign In
            </Button>
          </form>
      ...
      <footer className="pb-6 pt-4 text-center border-t border-emerald-100/30 bg-white/40 backdrop-blur-sm">
